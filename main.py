...
facts = ["Teknolojik bağımlılıktan mustarip olan çoğu kişi, kendilerini şebeke kapsama alanı dışında bulduklarında veya cihazlarını kullanamadıkları zaman yoğun stres yaşarlar.", 
...
animals = os.listdir("pipenvders\hayvan resimleri")
...
@app.route("/")
def homepage():
    return '<h1 style = "color : #2783D4; fontsize : 50px">Merhaba! eğlenceli şeyler için linklerden birine tıkla!</h1> <a style = "color : #F34336; fontsize : 25px" href="/techfact">Teknolojiyle ilgili rastgele bir gerçeği görüntüle!</a>'
@app.route("/animals")
def animals():
    return f'{random.choice(animals)}'
app.run(debug=True)
